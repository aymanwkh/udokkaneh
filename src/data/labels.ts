...
const labels: Label = {
  ...
  claims: 'الشكاوى',
  oneClaim: 'شكوى واحدة',
  twoClaims: 'شكوى مثبتة لذا توقف ظهور سعرك',
  ...
  help: 'للمساعدة والاقتراحات ... تواصل معنا من خلال الارقام التالية',
  ...
  simplePassword: 'كلمة السر المكونة من ارقام متتالية غير مسموحة'
}
